...
const Home = () => {
    ...
    const [carImage, setCarImage] = useState("/photos/1.jpg");
    ...
    return (
        <>
                ...
                <div className="intro-section">
                    <p>
                        OLDTIMER.VN — це автомобільна спільнота в місті Вінниця, метою якої є об'єднання людей,
                ...
                <div className="contact-icons">
                    ...
                    <div className="icon-box">
                        <a href="https://chat.whatsapp.com/Gowc8wF1BGsKmyyi0MuVCB" target="_blank">
                            <img src="/photos/icons/whatsaap-icon.png" alt="WhatsApp" className="icon-large" />
                        </a>
                        <a href="https://chat.whatsapp.com/Gowc8wF1BGsKmyyi0MuVCB" target="_blank">
